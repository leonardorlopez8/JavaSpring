...
@Controller
@RequestMapping(value="/ejemplos2")
public class EjemplosController2 {

	@RequestMapping(value = "/holamundo1", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/ejemplos/holamundo4conid/{id}", method = RequestMethod.GET)
	public String holaMundo4(@PathVariable Long id ,Model model)  {
		model.addAttribute("saludo", "Hola Mundo " + id);
